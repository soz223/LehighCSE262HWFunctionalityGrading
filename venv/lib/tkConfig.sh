...
TK_LIBS='-lX11   -lpthread -ldl -lz  -lpthread -lm'

# Top-level directory in which Tk's platform-independent files are
# installed.
TK_PREFIX='/workspaces/LehighCSE262HWFunctionalityGrading/venv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/workspaces/LehighCSE262HWFunctionalityGrading/venv'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/workspaces/LehighCSE262HWFunctionalityGrading/venv/lib -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/workspaces/LehighCSE262HWFunctionalityGrading/venv/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/workspaces/LehighCSE262HWFunctionalityGrading/venv/include'
...
# compiled.
TK_SRC_DIR='/workspaces/LehighCSE262HWFunctionalityGrading/venv/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/workspaces/LehighCSE262HWFunctionalityGrading/venv/lib -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/workspaces/LehighCSE262HWFunctionalityGrading/venv/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/workspaces/LehighCSE262HWFunctionalityGrading/venv/lib/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/workspaces/LehighCSE262HWFunctionalityGrading/venv/lib/libtkstub8.6.a'
